...
export default async function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      <header className="sticky top-0 inset-x-0 bg-surface/90 backdrop-blur-sm z-30 border-t-4 border-t-brand-700">
        <div className="max-w-md mx-auto px-5 pt-3 pb-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-navy-800 text-white flex items-center justify-center font-black text-sm shrink-0">
                {initial}
              </div>
              <div>
